...
Les quatre fichiers et ce texte sont repris du site
[retraitecomptenotionelle](https://github.com/g-pliberal/retraitecomptenotionelle) :
les deux volets du programme partagent leur typographie comme ils partagent
leur affiche.
...
Les `@font-face` sont en tête de `moteur/style.css`, avec leurs
`unicode-range`. La feuille est reprise du site
[retraitecomptenotionelle](https://github.com/g-pliberal/retraitecomptenotionelle),
où elle est engendrée depuis un module Python ; ici elle est un fichier
ordinaire, et se modifie donc à la main — en gardant à l'esprit que les deux
sites doivent continuer de se ressembler.
